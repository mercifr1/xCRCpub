...
#' Event data frame
#' -----------------
kras<-haven::read_sas("./data/PRIME/biomark_pds2019.sas7bdat")
kras0<-kras |> select("SUBJID", "BMMTR1")

adsl<-haven::read_sas("./data/PRIME/adsl_pds2019.sas7bdat")
event.df0<-adsl |>
...
#' -----------------
adtr<-haven::read_sas("./data/PRIME/adls_pds2019.sas7bdat")
biom.df0<-adtr |>
