...
kras<-haven::read_sas("../PRIME/data/biomark_pds2019.sas7bdat")
kras0<-kras |> select("SUBJID", "BMMTR1")

adsl<-haven::read_sas("../PRIME/data/adsl_pds2019.sas7bdat")
adsl0<-adsl |>
...
adtr<-haven::read_sas("../PRIME/data/adls_pds2019.sas7bdat")
...
saveRDS(adtr0, file="../PRIME/PRIMEads.rds")
